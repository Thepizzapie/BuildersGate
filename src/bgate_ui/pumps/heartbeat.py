...
on the follow-up router's existing tick (:func:`bgate_ui.agents.followup.tick`) rather
...
from bgate_core.store import db, events as _events, settings as _settings
