...
having none:
  ...
  1. THE AGENT GATE (``bgate_ui.agents.qa_gate``). A completed maker-seat item spawns a
...
# Shared with every other reader of this format - see bgate_core.board.agentlog,
...
#      source.
#   2. bgate_core.store.writelog — `.bgate/writes/item-<id>.jsonl`, written by the
