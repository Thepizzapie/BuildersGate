...
handler on the host side. bgate_ui/window/webview2.py talks to WebView2 through raw
...
bgate_ui.window.desktop when it opens and again with None when it closes. Every route
