...
The seat's other half. ``bgate_core.cine.cinematic`` does the work; this exposes it
...
from bgate_core.runtime.proc import run as _run
...
from bgate_core.runtime import ffmpegbin as _ffmpeg
