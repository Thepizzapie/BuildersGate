...
from bgate_core.level import jump as _jumpmod
from bgate_core.level import levelgen as _levelgen
from bgate_core.art import props as _props
from bgate_core.art import propsheet as _propsheet
from bgate_core.level import sidescroll as _sidescroll
...
def _read_prop_manifest(root, ref: str) -> dict:
    ...
    """
    from bgate_core.art import gameview as _gv
...
def _panel_mask(cell, wall_cells) -> int:
    from bgate_core.art import tilemask as _tm
