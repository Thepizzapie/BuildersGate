...
WHY THIS IS A SECOND MODULE. ``bgate_core.cine.cinematic`` ACQUIRES — it plans a shot
...
THE FIVE THINGS HERE, AND THE ORDER IS THE ORDER THEY DEPEND ON EACH OTHER.
  ...
  5. :func:`cutscene_scene_text` — the .tscn source: the video, the caption
     ...
     :func:`bgate_core.cine.cinematic.deliver` is what writes it into the engine
...
##
## GENERATED by Builders Gate (bgate_core.cine.cinecut). Safe to edit — nothing
