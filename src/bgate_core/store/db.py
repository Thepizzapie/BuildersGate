...
_MIGRATIONS: list = [
    ...
    # position still means something after a prune (see bgate_core.store.events).
    #
    ...
    # bgate_core.qa.feedback's classify() and route() do the work for both — but
    ...
    # Both are NOT NULL here and refused-when-blank in bgate_core/design/decisions.py,
    ...
    # 0047 - ITEM 26: 'parked', a status between 'queued' and 'cancelled'.
    _work_item_add_parked_status,

    # 0048 - ITEM 29: the 1800s (30 min) default runtime ceiling killed
