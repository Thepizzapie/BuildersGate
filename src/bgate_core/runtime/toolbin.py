...
WHERE THEY GO, and why this is not new. bgate_core/runtime/ffmpegbin.py already resolves
...
# bgate_core/runtime/ffmpegbin.py: the 8.1.1-full build from the same packager has a
