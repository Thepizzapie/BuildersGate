...
:mod:`bgate_core.board.queue` anywhere in this file. A "dispatch straight from chat"
...
things stacked:
  ...
  * :func:`bgate_core.qa.chatlink.sanitise` has already neutralised the message —
...
THE CLASSIFICATION IS bgate_core.qa.feedback'S, NOT A SECOND ONE. ``classify`` and
...
def _open_room(root: str | os.PathLike[str], session: dict, tally: dict,
    ...
    """
    from ..design import brainstorm as _bs
