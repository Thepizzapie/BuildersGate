...
ART_3D_WORKFLOW = (
    ...
    "• GEOMETRIC THINGS ARE SURFACES, NOT STACKED PRIMITIVES: bg_lathe a "
    "tyre or bottle, bg_loft a body from five outlines, bg_fuse trunk+branches "
    "into ONE shell, bg_shade every hard surface, bg_material presets baked "
    "by blender_bake, blender_decal for panel lines. Boxes are block-out, "
    "NOT the cast - a boxed car is a stand-in. THAT IS THE CEILING.\n"
