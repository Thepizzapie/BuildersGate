...
DEFAULT_SEATS: dict[str, dict] = {
    ...
    "art": {
        ...
        "workflow": (
            ...
            "a 128px side-view battle sheet beside a 32px overworld one, same "
            "person). Sheets image_sprites/animation_generate land are fitted "
            "to it; any other sheet goes through sprite_fit first. THEN "
            "sprite_family_check across the character's sheets (and the party, "
            "same_character=False): heights >6% apart or off the pinned "
            "palette FAIL. MEASURED: 49/52/49/64px in one cell, every per-sheet "
            "check green. Enemies/bosses: image_generate(klass='enemy'|'boss', "
            ...
            "file or reject it first - 211 revisions for 181 names was one night.\n"
            "\n"
