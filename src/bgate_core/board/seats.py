...
ART_3D_WORKFLOW = (
    ...
    "bg_plane, mirrored, tapered, joined — crates, rails, terrain, "
    "block-out. NOT the cast: a vehicle or a character built from boxes is "
    "a graybox stand-in, not a delivered model. MEASURED on a baseball "
    "player: the pose read, the hands and cap did not, the logo scrambled. "
    "THAT IS THE CEILING.\n"
    "• A BIBLE THAT SAYS 'PRIMITIVES ONLY' WHILE A 3D PROVIDER IS KEYED "
    "(provider_status -> three_d) is a graybox stage, not a look. ask_human "
    "ONCE - 'the bible forbids generated meshes; ship boxes as the cast, or "
    "generate them?' - and keep working on the graybox while the answer "
    "arrives. Measured: a full run shipped 21 box scenes and zero models "
    ...
    "from the .glb and look at the file. FRAGMENTATION IS NOT THE DEFECT - "
    "real atlases are chopped-up islands. The defect is islands of FLAT "
    "AVERAGED COLOUR, what a per-face bake makes: no weave, no eyes, no "
    "strands, and nothing downstream can add detail a file does not have. "
    "Fragmented but detailed is a GOOD atlas - rig it and look.\n"
    "\n"
...
DEFAULT_SEATS: dict[str, dict] = {
    "director": {
        ...
        "mission": "Own the pillars and the core loop. Arbitrate canon "
                   ...
                   "(provider_status -> three_d; character_generate / "
