...
from bgate_core.runtime import enginelock as _enginelock
...
# failure and a timeout), and `bgate_core.board.gitwork` recognises OUR override.cfg
...
def screenshot(project_dir: str, out_path: str, *, at: float = 1.0,
    ...
    try:
        ...
        # Windows and look exactly like a hang — see bgate_core.runtime.enginelock.
        try:
...
# grepping. Measured on 4.7.1 (see tests/adapters/test_adapters_adjust.py for the raw
...
# ---------------------------------------------------------------------------
# bgate_core.level.tilemap can now WRITE a TileSet as well as parse one, and those
