...
anyone looked at both. cinecut's :func:`~bgate_core.cinecut.runtime_of`,
:func:`~bgate_core.cinecut.captions` and :func:`~bgate_core.cinecut.xfade_graph`
...
def _ffmpeg(given: str = "") -> str:
    ...
    if not exe:
        raise AnimaticError(
            ...
            "bgate_core.ffmpegbin. Nothing has been generated, charged or "
            "written.")
    return str(exe)
