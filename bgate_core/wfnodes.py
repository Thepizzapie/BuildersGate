...
--------------------------------------
The workflow engine in :mod:`bgate_core.workflows` is a real DAG runner:
...
class ToolNodeRefused(ValueError):
    ...
    exactly like :class:`bgate_core.generate.GenerateRefused`.
    """
...
def run(root, *, run_id: int, node_id: str, label: str = "",
    ...
    identical on purpose, so :mod:`bgate_core.workflows` stores a tool node's
