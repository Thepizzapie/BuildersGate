...
# Credentials in a URL. The username half goes too: `https://marta:hunter2@...`
...
class Redactor:
    ...
    def text(self, value: str) -> str:
        ...
        # Paths before bare words: the username inside C:\Users\marta\... must
...
def _hostname() -> str:
    # A hostname is frequently the owner's name plus a device — "marta-pc" is
