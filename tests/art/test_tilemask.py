...
from bgate_core.art import tilemask
from bgate_core.art.autotile import E, N, S, W
...
class TestDiagonalsAreWhySixteenIsNotEnough:
    ...
    def test_all_forty_seven_masks_come_out(self):
        from bgate_core.art import autotile
    ...
    def test_a_missing_corner_bit_carves_that_corner(self):
        import numpy as np
        from bgate_core.art.autotile import E, N, NE, S, W
        both = N | E | S | W
    ...
    def test_a_corner_bit_is_ignored_when_its_sides_are_not_floor(self):
        ...
        import numpy as np
        from bgate_core.art.autotile import E, N, NE, canonical8
