...
from bgate_core.board import activity, queue, seats
from bgate_core.store import db, project, scaffold, settings
...
def test_the_gates_own_filter_holds_without_the_registry(root, monkeypatch):
    ...
    monkeypatch.setattr("bgate_core.store.settings.get",
