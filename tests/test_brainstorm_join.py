...
That is deliberately a stronger test than tests/test_brainstorm.py's. That one
...
from bgate_core import db, seats as _seats
...
def spawns(monkeypatch):
    ...
    fixture in tests/test_brainstorm.py and is the point: that file needs the
...
class TestASeatEntersWithoutItsTools:
    def test_the_invited_seat_is_spawned_read_only(self, client, spawns):
        ...
        Each flag below was checked (in tests/test_brainstorm.py, against the
