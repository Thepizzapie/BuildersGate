...
from bgate_core import chatfeedback as fb
from bgate_core import chatlink, db
...
class TestNothingReachesTheBoard:
    ...
    def test_the_module_cannot_reach_the_queue(self):
        """No import of bgate_core.queue, at module level or inside a function.

        The same assertion tests/test_brainstorm.py makes about the brainstorm
    ...
    def test_stop_calls_no_model(self, root, session, monkeypatch):
        ...
        from bgate_core import brainstorm as bs
