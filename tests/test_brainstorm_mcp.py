...
tests/test_brainstorm.py covers what the room is. This covers what changes when
...
class TestATurnCannotDispatch:
    ...
    def test_exactly_one_tool_can_reach_the_board(self):
        """file_plan is the only function in bgate_core.brainstorm that imports
...
MIRRORED = [
    ("bgate_core.brainstorm", "bgate_ui.routes.brainstorm", "_bs"),
    ("bgate_core.music", "bgate_ui.routes.music", "_music"),
]
