...
_LEVEL_RULE = (
    ...
    "prop_generate) -> level_plan -> level_generate.\n"
    ...
    "style problem, it is the wrong geometry.\n"
    "\u2022 You hold level_plan and level_generate. You do NOT hold the "
