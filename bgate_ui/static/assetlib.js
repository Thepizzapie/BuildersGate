...
window.AssetLib = (() => {
  ...
  function injectStyle(){
    ...
    s.textContent = [
      ...
      ".al-chip b{color:var(--bone);font-weight:600}",
      ...
      ".al-cover{position:relative;min-height:96px;max-height:190px;display:flex;align-items:center;justify-content:center;padding:9px;background-color:#0d0f13;background-image:linear-gradient(45deg,#15181d 25%,transparent 25%,transparent 75%,#15181d 75%),linear-gradient(45deg,#15181d 25%,#0d0f13 25%,#0d0f13 75%,#15181d 75%);background-size:14px 14px;background-position:0 0,7px 7px}",
      ...
      ".al-dim{position:absolute;right:6px;bottom:5px;font-family:var(--mono);font-size:8.5px;color:var(--ash2);background:rgba(8,9,12,.82);border-radius:4px;padding:1px 5px}",
      ".al-more{position:absolute;left:6px;bottom:5px;font-family:var(--mono);font-size:8.5px;color:var(--bone);background:rgba(8,9,12,.82);border-radius:4px;padding:1px 5px}",
      ...
      ".al-b.use{border-color:#2f5f45;color:var(--good)}",
      ".al-b.no{border-color:#6d5326;color:var(--warn)}",
      ".al-b.rig{border-color:#3f5a7d;color:#7fb3ff}",
      ".al-b.rev{border-color:#7d4338;color:#ff9379}",
      ...
      ".al-dh h3{margin:0;font-size:16px;color:var(--bone);font-weight:600}",
      ...
      ".al-sheet{padding:10px;background-color:#0d0f13;background-image:linear-gradient(45deg,#15181d 25%,transparent 25%,transparent 75%,#15181d 75%),linear-gradient(45deg,#15181d 25%,#0d0f13 25%,#0d0f13 75%,#15181d 75%);background-size:14px 14px;background-position:0 0,7px 7px;overflow-x:auto}",
      ...
      ".al-btn.go{background:var(--ember);color:#111;border-color:var(--ember);font-weight:600}",
