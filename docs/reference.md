...
| 3D forms | `blender_hull`, `blender_skin`, `blender_blob`, `blender_tube`, `blender_rock` | The smooth shape built FIRST: a body from its silhouettes, a creature from a stick figure, merged blobs, swept tubes, seeded boulders |
