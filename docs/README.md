...
| [faq.md](faq.md) | The questions people actually asked, answered against the code: how the character art was really made, whether it works for 3D, what it costs, why it felt slow, and pointing it at a game you already have. |
